    ...
    <form id="formEditDesa" method="POST">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="control">
            <input type="text" name="name" id="edit_name" class="input" placeholder="Masukkan nama desa" required>
          </div>
        </div>
      </div>
    ...
    $(document).ready(function() {
      ...
      document.querySelectorAll('.btn-edit-desa').forEach(btn => {
        btn.addEventListener('click', async function() {
          ...
          // Set form action
          document.getElementById('formEditDesa').action = '{{ route("admin.desa.update", ":id") }}'.replace(':id', id);
