...
<section class="card">
  <form method="POST" action="{{ route('admin.permohonan.update', $permohonan) }}" id="formPermohonan">
    ...
    <div class="form-group">
      ...
      <input type="text" name="nama" class="input" value="{{ old('nama', $permohonan->nama) }}" placeholder="Masukkan nama permohonan" required>
    </div>
    ...
    <div class="form-group">
      ...
      <select name="jenis_permohonan" class="input" required>
        ...
        <option value="desa" {{ old('jenis_permohonan', $permohonan->jenis_permohonan) == 'desa' ? 'selected' : '' }}>Desa</option>
        <option value="perusahan" {{ old('jenis_permohonan', $permohonan->jenis_permohonan) == 'perusahan' ? 'selected' : '' }}>Perusahaan</option>
      </select>
    </div>
