        ...
        <form id="formEditPerusahaan" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input type="text" name="nama" id="edit_nama" class="input"
                ...
                {{-- Nama Pimpinan --}}
                <div class="form-group">
                    <label class="label">Nama Pimpinan Perusahaan</label>
                    <div class="control">
                        <input type="text" name="nama_pimpinan" id="edit_nama_pimpinan" class="input"
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input type="text" name="kontak" id="edit_kontak" class="input"
                ...
                <p style="font-size:12px;color:#64748B;margin-bottom:12px;"><i class="ri-information-line"></i>
                    Opsional: Pilih
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (selDisEdit && selVilEdit) {
                const disChangeHandler = async function() {
                    ...
                    if (!did) return;
                    const res = await fetch(
                        '{{ route('admin.perusahaan.options.villages') }}?district_id=' +
            ...
            document.querySelectorAll('.btn-edit-perusahaan').forEach(btn => {
                btn.addEventListener('click', async function() {
                    ...
                    const namaPimpinan = this.getAttribute('data-nama-pimpinan');
                    ...
                    document.getElementById('formEditPerusahaan').action =
                        '{{ route('admin.perusahaan.update', ':id') }}'.replace(':id', id);

                    // Set nama, kontak, alamat, and kabupaten_kota
                    document.getElementById('edit_nama').value = nama;
                    document.getElementById('edit_nama_pimpinan').value = namaPimpinan || '';
                    ...
                    if (jQuery && jQuery.fn.select2 && jQuery(selReg).hasClass(
                    ...
                    if (regencyId) {
                        ...
                        // Destroy Select2 if initialized
                        if (jQuery && jQuery.fn.select2 && jQuery(selVil).hasClass(
                                'select2-hidden-accessible')) {
                            jQuery(selVil).select2('destroy');
                        }

                        if (districtId) {
                            const resVil = await fetch(
                                '{{ route('admin.perusahaan.options.villages') }}?district_id=' +
