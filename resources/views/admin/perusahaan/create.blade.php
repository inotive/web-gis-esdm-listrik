        ...
        <form id="formCreatePerusahaan" method="POST" action="{{ route('admin.perusahaan.store') }}">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input type="text" name="nama" id="cNama" class="input"
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input type="text" name="nama_pimpinan" id="cNamaPimpinan" class="input"
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input type="text" name="kontak" id="cKontak" class="input"
        ...
        (function() {
            ...
            async function loadRegencies() {
                ...
                if (jQuery && jQuery.fn.select2) {
                    ...
                    jQuery(selReg).select2({
                        ...
                        '#modalCreatePerusahaan'), // Ensure dropdown is rendered inside modal
                        language: {
                            noResults: function() {
            ...
            async function loadDistricts(regencyId) {
                ...
                const res = await fetch(
                    `{{ route('admin.perusahaan.options.districts') }}?regency_id=${encodeURIComponent(regencyId)}`
                    );
                const rows = await res.json();
                ...
                if (jQuery && jQuery.fn.select2) {
                    ...
                    setTimeout(function() {
                        ...
                        jQuery(selDis).on('select2:select', function(e) {
                            ...
                            // Ensure the option is selected in the DOM
                            $select.find('option').prop('selected', false);
                            $select.find('option[value="' + districtId + '"]').prop('selected',
                                true);
            ...
            async function loadVillages(districtId) {
                ...
                const res = await fetch(
                    `{{ route('admin.perusahaan.options.villages') }}?district_id=${encodeURIComponent(districtId)}`
                    );
                const rows = await res.json();
                ...
                if (jQuery && jQuery.fn.select2) {
                    ...
                    setTimeout(function() {
                        ...
                        jQuery(selVil).on('select2:select', function(e) {
                            ...
                            // Ensure the option is selected in the DOM
                            $select.find('option').prop('selected', false);
                            $select.find('option[value="' + villageId + '"]').prop('selected',
                            true);
