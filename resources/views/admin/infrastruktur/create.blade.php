{{-- resources/views/admin/infrastruktur/create.blade.php --}}
<div id="modalCreateInfra" class="modal-overlay" aria-hidden="true">
  <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modalCreateInfraTitle">
    <div class="modal-header">
      ...
      <button type="button" class="btn-x" onclick="__closeModal('modalCreateInfra')" aria-label="Tutup">
      ...
      <div class="modal-body">
        <div class="form-grid">
          ...
          <div class="f">
            ...
            <input type="text" name="jenis" class="input" placeholder="Contoh: SUTT 150 kV" required>
            @error('jenis')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
          ...
          <div class="f full">
            ...
            <input type="number" step="0.01" min="0" name="panjang_jaringan" class="input" placeholder="Contoh: 150.50" required>
