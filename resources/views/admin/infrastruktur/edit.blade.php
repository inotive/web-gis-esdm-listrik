{{-- resources/views/admin/infrastruktur/edit.blade.php --}}
<div id="modalEditInfra" class="modal-overlay" aria-hidden="true">
  <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modalEditInfraTitle">
    <div class="modal-header">
      ...
      <button type="button" class="btn-x" onclick="__closeModal('modalEditInfra')" aria-label="Tutup">
    ...
    <form id="formEditInfra" method="POST" action="#">
      ...
      <div class="modal-body">
        <div class="form-grid">
          ...
          <div class="f">
            ...
            <input id="jenis_edit" type="text" name="jenis" class="input" placeholder="Contoh: SUTT 150 kV" required>
            @error('jenis')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
          ...
          <div class="f full">
            ...
            <input id="panjang_edit" type="number" step="0.01" min="0" name="panjang_jaringan" class="input" placeholder="Contoh: 150.50" required>
            @error('panjang_jaringan')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
        </div>
      ...
      <div class="modal-footer">
        <button class="btn-save" type="submit">
          <i class="ri-save-3-line"></i> Perbarui
        </button>
      </div>
    </form>
  </div>
