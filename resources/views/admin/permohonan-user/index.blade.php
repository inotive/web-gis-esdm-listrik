...
@section('content')
    ...
    <section class="card" style="margin-top:18px;">
        <div class="card-header">
            <form id="filterForm" class="toolbar" method="GET"
                action="{{ route('admin.permohonan-user.index', $permohonanId) }}">
                        ...
                        @forelse ($permohonanUsers as $i => $permohonanUser)
                            <tr>
                                ...
                                <td class="col-aksi">
                                    ...
                                    @if ($isAdmin)
                                        {{-- Admin: Edit button --}}
                                        <a href="{{ route('admin.permohonan-user.edit', [$permohonanId, $permohonanUser]) }}"
                                            class="btn-ico edit" title="Edit Data">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11 4H4C3.46957 4 2.96086 4.21071 2.58579 4.58579C2.21071 4.96086 2 5.46957 2 6V20C2 20.5304 2.21071 21.0391 2.58579 21.4142C2.96086 21.7893 3.46957 22 4 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V13"
                                                    stroke="#DFA000" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                                                    d="M18.5 2.50001C18.8978 2.10219 19.4374 1.87869 20 1.87869C20.5626 1.87869 21.1022 2.10219 21.5 2.50001C21.8978 2.89784 22.1213 3.4374 22.1213 4.00001C22.1213 4.56262 21.8978 5.10219 21.5 5.50001L12 15L8 16L9 12L18.5 2.50001Z"
                                                    stroke="#DFA000" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <circle cx="20" cy="4" r="1" fill="#DFA000" />
                                            </svg>
                                        </a>
                                        ...
                                        @elseif($permohonanUser->status === 'selesai')
                                            ...
                                            <a href="{{ route('admin.permohonan-user.show', [$permohonanId, $permohonanUser]) }}"
            ...
            <div class="modal-content">
                ...
                <form id="approveForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="keterangan_approve" class="form-label">Catatan <span
                                    class="text-muted">(Opsional)</span></label>
                            <textarea class="form-control" id="keterangan_approve" name="keterangan" rows="3"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="documents[0][nama]" placeholder="Nama dokumen">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small">File</label>
                                            <input type="file" class="form-control form-control-sm"
                                                name="documents[0][file]" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label small">Masa Berlaku</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="documents[0][masa_berlaku]">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <button type="button" class="btn btn-sm btn-secondary" id="addDocumentBtn"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="progressForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="keterangan_progress" class="form-label">Catatan <span
                                    class="text-muted">(Opsional)</span></label>
                            <textarea class="form-control" id="keterangan_progress" name="keterangan" rows="4"
                                placeholder="Tambahkan catatan jika diperlukan..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="rejectForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="keterangan_reject" class="form-label">Alasan Penolakan <span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control" id="keterangan_reject" name="keterangan" rows="4"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-approve-permohonan-user').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action =
                        `{{ route('admin.permohonan-user.index', $permohonanId) }}/${permohonanUserId}/approve`;
                    document.getElementById('approveModalLabel').textContent =
                        `Setujui Permohonan: ${permohonanName}`;
        ...
        `;
            ...
            document.querySelectorAll('.btn-progress-permohonan-user').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action =
                        `{{ route('admin.permohonan-user.index', $permohonanId) }}/${permohonanUserId}/progress`;
                    document.getElementById('progressModalLabel').textContent =
                        `Update Status ke Proses: ${permohonanName}`;
            ...
            document.querySelectorAll('.btn-reject-permohonan-user').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action =
                        `{{ route('admin.permohonan-user.index', $permohonanId) }}/${permohonanUserId}/reject`;
                    document.getElementById('rejectModalLabel').textContent =
                        `Tolak Permohonan: ${permohonanName}`;
