...
@section('content')
    ...
    <section class="card">
        <form method="POST" action="{{ route('admin.permohonan-user.store', $permohonanId) }}" id="permohonanForm"
            ...
            <div class="form-actions">
                <a href="{{ route('admin.permohonan-user.index', $permohonanId) }}" class="btn btn-secondary">
