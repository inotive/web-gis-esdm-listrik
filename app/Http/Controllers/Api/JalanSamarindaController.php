...
class JalanSamarindaController extends Controller
{
    /**
     * Convert UTM coordinates to WGS84 (latitude/longitude)
     * Assuming Samarinda is in UTM Zone 50S (Southern Hemisphere) like Balikpapan
     */
            ...
            if ($item->geom) {
                ...
                $feature = [
                    ...
                    'properties' => [
                        ...
                        'FONT_CHARS' => $item->FONT_CHARS,
                        'FONT_WEIGH' => $item->FONT_WEIGH,
                        'ELEVATION' => $item->ELEVATION,
                        'MAP_NAME' => $item->MAP_NAME,
                        'GM_LAYER' => $item->GM_LAYER,
                        'GM_TYPE' => $item->GM_TYPE,
                        ...
                        'Kord_X_Awa' => $item->Kord_X_Awa,
                        'Kord_X_Akh' => $item->Kord_X_Akh,
                        'Kord_Y_Awa' => $item->Kord_Y_Awa,
                        'Kord_Y_Akh' => $item->Kord_Y_Akh,
                        'Kord_Y_a_1' => $item->Kord_Y_a_1,
                    ],
                    'geometry' => $geometry
                ];
