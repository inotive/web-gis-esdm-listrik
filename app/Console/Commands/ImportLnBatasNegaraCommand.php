...
class ImportLnBatasNegaraCommand extends Command
{
    protected $signature = 'ln-batas-negara:import 
                            {--file= : Path relatif dari folder public ke file GeoJSON}';

    protected $description = 'Import data LN BATAS NEGARA dari file GeoJSON ke tabel table__l_n__batas__negara';
    ...
    public function handle(): int
    {
        ...
        if ($fileOpt === '') {
            $this->error('Option --file wajib diisi, contoh: --file="public/assets/Administrasi/LN_BATAS_NEGARA.json"');
            return 1;
        }
        ...
        $this->info('Mengosongkan tabel table__l_n__batas__negara sebelum import ...');
        LN_Batas_Negara::truncate();

        $this->info('Memulai import data LN BATAS NEGARA ...');
