...
class ImportPtGarduIndukKutimCommand extends Command
{
    protected $signature = 'pt-gardu-induk-kutim:import 
                            {--file= : Path relatif dari folder public ke file GeoJSON}';

    protected $description = 'Import data PT Gardu Induk Kutim dari file GeoJSON ke tabel table__p_t__gardu__induk__kutim';
    ...
    public function handle(): int
    {
        ...
        if ($fileOpt === '') {
            $this->error('Option --file wajib diisi, contoh: --file="public/assets/Infrastruktur/PT_Gardu_Induk_Kutim.json"');
            return 1;
        }
        ...
        $this->info('Mengosongkan tabel table__p_t__gardu__induk__kutim sebelum import ...');
        PT_Gardu_Induk_Kutim::truncate();

        $this->info('Memulai import data PT Gardu Induk Kutim ...');
        ...
        foreach ($data['features'] as $index => $feature) {
            ...
            $model = new PT_Gardu_Induk_Kutim();
