...
class ImportPtPembangkitEksistingCommand extends Command
{
    protected $signature = 'pt-pembangkit-eksisting:import 
                            {--file= : Path relatif dari folder public ke file GeoJSON}';

    protected $description = 'Import data PT Pembangkit Eksisting dari file GeoJSON ke tabel table__p_t__pembangkit__eksisting';
    ...
    public function handle(): int
    {
        ...
        if ($fileOpt === '') {
            $this->error('Option --file wajib diisi, contoh: --file="public/assets/Infrastruktur/PT_Pembangkit_Eksisting.json"');
            return 1;
        }
        ...
        $this->info('Mengosongkan tabel table__p_t__pembangkit__eksisting sebelum import ...');
        PT_Pembangkit_Eksisting::truncate();

        $this->info('Memulai import data PT Pembangkit Eksisting ...');
        ...
        foreach ($data['features'] as $index => $feature) {
            ...
            $model = new PT_Pembangkit_Eksisting();
