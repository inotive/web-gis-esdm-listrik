...
use App\Models\PT_Sistem_Infrastruktur_Energi_Mahulu;

class ImportPtSistemInfrastrukturEnergiMahuluCommand extends Command
{
    protected $signature = 'pt-energi:mahulu-import
                            {--file= : Path relatif dari folder public ke file GeoJSON}';

    protected $description = 'Import data sistem infrastruktur energi Mahakam Ulu dari file GeoJSON ke tabel table__p_t__sistem__infrastruktur__energi__mahulu';
    ...
    public function handle(): int
    {
        ...
        if ($fileOpt === '') {
            $this->error('Option --file wajib diisi, contoh: --file="public\assets\Energi-Infrastruktur\PT_Sistem_Infrastruktur_Energi_Mahulu.json"');
            return 1;
        }
        ...
        $this->info('🚧 Memulai import data Sistem Infrastruktur Energi Mahulu ...');
        ...
        foreach ($data['features'] as $index => $feature) {
            ...
            if ($objectId !== null) {
                $model = PT_Sistem_Infrastruktur_Energi_Mahulu::firstOrNew(['objectid' => $objectId]);
            } else {
                $model = new PT_Sistem_Infrastruktur_Energi_Mahulu();
            }
