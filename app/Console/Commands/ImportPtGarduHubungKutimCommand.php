...
class ImportPtGarduHubungKutimCommand extends Command
{
    protected $signature = 'pt-gardu-hubung-kutim:import 
                            {--file= : Path relatif dari folder public ke file GeoJSON}';

    protected $description = 'Import data PT Gardu Hubung Kutim dari file GeoJSON ke tabel table__p_t__gardu__hubung__kutim';
    ...
    public function handle(): int
    {
        ...
        if ($fileOpt === '') {
            $this->error('Option --file wajib diisi, contoh: --file="public/assets/Infrastruktur/PT_Gardu_Hubung_Kutim.json"');
            return 1;
        }
        ...
        $this->info('Mengosongkan tabel table__p_t__gardu__hubung__kutim sebelum import ...');
        PT_Gardu_Hubung_Kutim::truncate();

        $this->info('Memulai import data PT Gardu Hubung Kutim ...');
        ...
        foreach ($data['features'] as $index => $feature) {
            ...
            $model = new PT_Gardu_Hubung_Kutim();
            $model->nama     = $nama;
